...
*Companies: enter MySQL container*

```bash
docker-compose exec mysql bash
```

*Companies: enter to MySQL prompt within MySQL container*
...
1 - Run the NetData Container (`netdata`) with the `docker-compose up` command. Companies:
...
1 - Run the Metabase Container (`metbase`) with the `docker-compose up` command. Companies:
...
1 - Run the phpMyAdmin Container (`phpmyadmin`) with the `docker-compose up` command. Companies:
...
1 - Run the Gitlab Container (`gitlab`) with the `docker-compose up` command. Companies:
...
1 - Run the Adminer Container (`adminer`) with the `docker-compose up` command. Companies:
...
1 - Run the Portainer Container (`portainer`) with the `docker-compose up` command. Companies:
...
1 - Run the pgAdmin Container (`pgadmin`) with the `docker-compose up` command. Companies:
...
1 - Run the Selenium Container (`selenium`) with the `docker-compose up` command. Companies:
...
2 - Run the Minio Container (`minio`) with the `docker-compose up` command. Companies:
...
2 - Run the Thumbor Container (`minio`) with the `docker-compose up` command. Companies:
...
2 - Run the Aws Container (`aws`) with the `docker-compose up` command. Companies:
...
That's it! Run your containers.. Companies:
